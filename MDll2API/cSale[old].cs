    ...
    public class cSale
    {
        ...
        private string C_GETtSQL(string ptLastUpd,Int64 pnRowTop = 100,Double pcPoint = 1)
        {
            ...
            try
            {
                ...
                oSQL.AppendLine("       '45'");
                //oSQL.AppendLine("       WHEN HD.FTShdTransType IN ('06') AND FTShdStaBigLot = 'Y' THEN");
                //oSQL.AppendLine("       '43'");
               ...
               // oSQL.AppendLine("     CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + '\"Description\": \"' + FTSkuAbbName + '\",' + CHAR(10) + ");
                ...
                oSQL.AppendLine("       CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + '\"RegularSalesUnitPrice\": \"' + CONVERT(VARCHAR, CONVERT(DECIMAL(18, 2), (CASE WHEN FTShdTransType IN ('11', '27') THEN Round(FCSdtB4DisChg  - ((FCSdtB4DisChg * FCSdtTax) / (100 + FCSdtTax)), 2)" +
                                        "WHEN FTShdTransType IN ('06', '16') AND ISNULL(FTSdtStaSalType, '') = '2'  THEN FCSdtSaleAmt " +
                                        "ELSE FCSdtRegPrice END ))) + '\",' + CHAR(10) + ");

                oSQL.AppendLine("     CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + '\"ActualSalesUnitPrice\": \"' + CONVERT(VARCHAR, CONVERT(DECIMAL(18, 2), FCSdtSaleAmt)) + '\",' + CHAR(10) + ");   //*Em 61-07-12
                ...
                oSQL.AppendLine("     CASE WHEN ISNULL((SELECT TOP 1 FTShdTransNo FROM TPSTSalCD with(nolock) ");
                ...
                oSQL.AppendLine("   ELSE");
                oSQL.AppendLine("   CASE WHEN FTShdTransType NOT IN('06', '16') AND ISNULL(FTSdtStaSalType, '') <> '2' or FTShdTransType IN('06', '16') AND ISNULL(FTSdtStaSalType, '') = '1'  THEN");
                ...
                //    " AND FDShdTransDate = TPSTSalDT.FDShdTransDate AND FTSpoID = TPSTSalDT.FTSkuCode  AND FTSRVName = TPSTSalDT.FTSRVName) > 1 " +
                ...
                oSQL.AppendLine("AND po.FDShdTransDate = TPSTSalDT.FDShdTransDate AND po.FTSpoID = TPSTSalDT.FTSkuCode  AND po.FTSRVName = TPSTSalDT.FTSRVName) as xdata");
                ...
                oSQL.AppendLine("	WHERE FTShdTransType IN('03','04','05','06','10','11','14','15','16','21','22','23','26','27') AND ISNULL(FTStaSentOnOff, '0')<>'1' AND FCShdGrand > 0  ");
                ...
                else if (tC_Auto == "MANUAL")
                {
                    ...
                    oSQL.AppendLine("WHERE ISNULL(HD.FTStaSentOnOff, '0') <> '1' AND HD.FCShdGrand > 0 AND " + oC_RcvSale.Field + oC_RcvSale.Value + " ");
                }
